...
export const ui = {
  es: {
    ...
    'skills.other': 'Otras',
    'contact.paragraph.1': `Hey, soy andino rodrigo un estudiante en licenciatura de informática
  ...
  en: {
    ...
    'skills.other': 'Other',
    'contact.paragraph.1': `Hey, I'm andino rodrigo a student in computer science degree at the
